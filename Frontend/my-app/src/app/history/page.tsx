                  ...
                  >
                    <div>
                      <h3 className="text-lg font-semibold">
                        {name} ({items[0].internationalName})
                      </h3>
                      ...
                      {items.map((item) => (
                        ...
                        >
                          ...
                          <table className="w-full mt-2 border-collapse">
                            ...
                            <tbody>
                              {Object.entries(item.category).map(
                                ([category, areas]) => (
                                  <tr key={category}>
                                    <td className="py-2 px-4 font-semibold w-1/5">
                                      Category {category}
                                    </td>
                                    <td className="py-2 px-4 w-4/5">
                                      {areas.join(', ')}
                                    </td>
                                  </tr>
                                )
